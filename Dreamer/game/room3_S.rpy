...
label s_room_start :
    ...
    #scene 4 만찬장 with dissolve or fade
...
label s_room_1_a:
    ...
    s "얼어붙더라도 만나고 싶어. 단 한 번이라도 안겨 보고 싶다고."
    a "그게 과연 저들이 원하는 일일까?"
    ...
    s "아버지! 어머니!"
    a "그래봤자 너만 손해야. 아까 T가 했던 일이랑 똑같아. 백날 이미 없어진 주인같은 걸 그리워해봤자 아무것도 바뀌지 않는다고."
...
label s_room_2_a:
    ...
    menu:
        "부모님을 마지막으로 안아본다.":
            ...
            # scene 5 : 식탁 다른 각도 + 얼어붙은 아버지 + 이쪽을 바라보는 어머니
...
label s_room_1_j:
    ...
    s "얼어붙더라도 만나고 싶어. 단 한 번이라도 안겨 보고 싶다고."
    j "그게 과연 네 가족이 원하는 일일까? 나는 여기서 어린 카슈를 품에 안은 게 가장 후회되는 일이라고."
    ...
    j "그래봤자 너만 손해야. S.."
    s "두 분 모두 안녕을 말 할 시간도 없이 돌아가셨어. 너무나 갑작스럽게. 하지 못 한 이야기들이 너무 많아. 너무 많아서 무슨 말을 먼저 해야 할 지 모를 정도로.."
    j "그렇다고 여기 눌러앉아서 벽을 두드릴 수는 없어. 응?"
    s "부모님이 불러주시는 내 이름을 한 번이라도 더 듣고 싶어."
    ...
    s "..."
    j "환상이 강력한 것은 나도 인정해. 알아. 하지만 환상을 깨부숴야 현실을 살지."
    j "우리 지금까지 잘 버텨 왔잖아. 돌아가신 네 부모님도 네가 무사히 꿈에서 빠져나오길 바랐을 거야."

    menu:
        "J의 말이 맞다. 몸 전체가 얼기 전에 방을 나가자." :
            s "..그래 J,네 말이 맞아."
            j "카슈도, 정원도, 그런 환상이었잖아. 그렇지만 다들 잘 떠나왔어. ...열쇠를 향해 가려고."
            s "나를 기다린다고 했지."
...
label s_room_2_j:
    ...
    j "{i}(....잠시만 저건 뭐지? 레버잖아..?){/i}" (what_color = "#B4B4B4", what_size = 24)
