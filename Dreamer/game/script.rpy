...
# 게임에서 사용할 캐릭터를 정의합니다.
    define s = Character("S", color = "#303030")
    define j = Character("J", color = "#F0ACC6")
    define uj = Character("???", color = "#F0ACC6")
    define a = Character("A", color = "#20425E")
    define t = Character("T", color = "#E39861")
    define k = Character("카슈", color = "#EBE3CE")
    define c = Character("아이", color = "#cbcbcb")
    define uc = Character("???", color = "#cbcbcb")
