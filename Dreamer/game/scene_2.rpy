...
label scene_2_start :
    ...
    t "네, 확인되었습니다. 얼음성에서 좋은 시간 보내십시오. 나머지 손님들도 출입증을 주세요. 귀여운 강아지 손님도 있네요."

    "J와 나의 출입증도 통과되었다. T는 인사를 하고 저 멀리 사라져갔다."
    "연회장 한 켠엔 너무나 맛있어 보이는 음식들이 한가득 쌓여 있었다. 컵케잌 하나라도 집어먹을 수 있으면..."

    a "정신 차려! 우린 여기 연회를 즐기러 온 게 아니야. 저 뒤편 복도로 눈에 띄지 않고 가야 해. 최대한 자연스럽게 행동해."
    j "알겠어."
    "J는 카슈를 가슴에 꼭 안았다."
    s "그래."
...
label scene_2_2:
    t "저는 T에요. 얼음성의 선임 웨이터죠. 그동안 얼음성에 종종 산 사람들이 들어오곤 했어요. 그래서..."
